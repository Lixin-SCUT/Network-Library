...
void Connector::connecting(int sockfd)
{
	...
	channel_->setErrorCallback(
		std::bind(&Connector::handleErrno,this));
...
int Connector::removeAndResetChannel()
{
	...
	// Can't reset channel_ here, because inside Channel::handleEvent
...
void Connector::handleWrite()
{
	...
	if(state_ == kConnecting)
	{
		int sockfd = removeAddResetChannel();
		...
		{
			LOG_WARM << "Connector::handleWrite - Self connect";
			retry(sockfd);
		}
		else
		{
...
void Connector::handleError()
{
	...
	{
		int sockfd = removeAndResetChannel();
		int err = sockets::getSokcetError(sockfd);
